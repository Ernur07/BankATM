 ...
 */
public class SecurityAccountTableModel extends AbstractTableModel {
    private String[] columnNames={"Name","Balance","Currency","Interest rate"};
    private ArrayList<SecurityAccount> accounts;

    public SecurityAccountTableModel(ArrayList<SecurityAccount> accounts){
